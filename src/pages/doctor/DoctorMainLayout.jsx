...
const DoctorMainLayout = () => {
  ...
  const navItems = [
    ...
    { id: 'patients', icon: <Users className="h-4 w-4" />, label: 'Patients' },
    { id: 'subscription', icon: <CreditCard className="h-4 w-4" />, label: 'Subscription' },
    { id: 'settings', icon: <SettingsIcon className="h-4 w-4" />, label: 'Settings' }
  ];
